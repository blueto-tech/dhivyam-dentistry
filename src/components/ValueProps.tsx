...
function ValueCard({ icon: Icon, title, description, delay }) {
  return (
    ...
    >
      ...
      <div className="relative bg-white border-2 border-blue-200 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 md:min-h-[400px] flex flex-col justify-between">
